...
# Introduction
Rotom-Teamsheet is a local-only Node application that converts Poke Pastes (pokepaste.es) containing statistics of Pokemon teams into a teamsheet for use at Pokemon VGC Local events.
...
- Live internet connection (for fetching the paste, and pokemon stat spreads.
